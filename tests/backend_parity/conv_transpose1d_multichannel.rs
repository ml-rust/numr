...
/// F16 and BF16 run the product in F32 and round once at the fold, which is
/// the same accumulation the CPU reference performs. Bias and batch both on,
/// so the fold's bias add and batch stride are covered.
#[test]
