...
// implemented and benchmarked and lost - I32 1024x1024 was SLOWER
// double-buffered, every other case within noise. `Numr128` accumulation
// is a software 128-bit multiply-add, so
