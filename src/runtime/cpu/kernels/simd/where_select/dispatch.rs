//! Entry points and SIMD-level dispatch for conditional select (where) operation
...
pub unsafe fn where_f32(cond: *const u8, x: *const f32, y: *const f32, out: *mut f32, len: usize) {
    ...
    match level {
        SimdLevel::Avx512 => super::avx512::where_f32(cond, x, y, out, len),
        SimdLevel::Avx2Fma => super::avx2::where_f32(cond, x, y, out, len),
    ...
    match level {
        SimdLevel::Neon | SimdLevel::NeonFp16 => {
            super::aarch64::neon::where_f32(cond, x, y, out, len)
        }
        _ => where_scalar_f32(cond, x, y, out, len),
    }
...
pub unsafe fn where_f64(cond: *const u8, x: *const f64, y: *const f64, out: *mut f64, len: usize) {
    ...
    #[cfg(target_arch = "x86_64")]
    match level {
        SimdLevel::Avx512 => super::avx512::where_f64(cond, x, y, out, len),
        SimdLevel::Avx2Fma => super::avx2::where_f64(cond, x, y, out, len),
    ...
    match level {
        SimdLevel::Neon | SimdLevel::NeonFp16 => {
            super::aarch64::neon::where_f64(cond, x, y, out, len)
        }
        _ => where_scalar_f64(cond, x, y, out, len),
    }
