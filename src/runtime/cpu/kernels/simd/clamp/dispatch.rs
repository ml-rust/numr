//! Entry points and SIMD-level dispatch for clamp operation

use super::scalar::{clamp_scalar_f32, clamp_scalar_f64};
...
pub unsafe fn clamp_f32(a: *const f32, out: *mut f32, len: usize, min_val: f32, max_val: f32) {
    ...
    match level {
        SimdLevel::Avx512 => super::avx512::clamp_f32(a, out, len, min_val, max_val),
        SimdLevel::Avx2Fma => super::avx2::clamp_f32(a, out, len, min_val, max_val),
    ...
    match level {
        SimdLevel::Neon | SimdLevel::NeonFp16 => {
            super::aarch64::neon::clamp_f32(a, out, len, min_val, max_val)
        }
        _ => clamp_scalar_f32(a, out, len, min_val, max_val),
    }
...
pub unsafe fn clamp_f64(a: *const f64, out: *mut f64, len: usize, min_val: f64, max_val: f64) {
    ...
    #[cfg(target_arch = "x86_64")]
    match level {
        SimdLevel::Avx512 => super::avx512::clamp_f64(a, out, len, min_val, max_val),
        SimdLevel::Avx2Fma => super::avx2::clamp_f64(a, out, len, min_val, max_val),
    ...
    match level {
        SimdLevel::Neon | SimdLevel::NeonFp16 => {
            super::aarch64::neon::clamp_f64(a, out, len, min_val, max_val)
        }
        _ => clamp_scalar_f64(a, out, len, min_val, max_val),
    }
