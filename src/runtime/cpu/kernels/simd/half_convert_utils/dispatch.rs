//! Entry points and architecture dispatch for f16/bf16 <-> f32 conversion

#[cfg(not(any(target_arch = "x86_64", target_arch = "aarch64")))]
use super::scalar::{
    convert_bf16_to_f32_scalar, convert_f16_to_f32_scalar, convert_f32_to_bf16_scalar,
    convert_f32_to_f16_scalar,
};
...
pub unsafe fn convert_f16_to_f32(src: *const u16, dst: *mut f32, len: usize) {
    ...
    #[cfg(target_arch = "x86_64")]
    {
        if is_x86_feature_detected!("f16c") {
            return super::x86_64::convert_f16_to_f32_f16c(src, dst, len);
        }
    }

    #[cfg(target_arch = "aarch64")]
    {
        return super::aarch64::convert_f16_to_f32_neon(src, dst, len);
    }
...
pub unsafe fn convert_f32_to_f16(src: *const f32, dst: *mut u16, len: usize) {
    ...
    {
        if is_x86_feature_detected!("f16c") {
            return super::x86_64::convert_f32_to_f16_f16c(src, dst, len);
        }
    }

    #[cfg(target_arch = "aarch64")]
    {
        return super::aarch64::convert_f32_to_f16_neon(src, dst, len);
    }
...
pub unsafe fn convert_bf16_to_f32(src: *const u16, dst: *mut f32, len: usize) {
    ...
    #[cfg(target_arch = "x86_64")]
    {
        if is_x86_feature_detected!("avx2") {
            return super::x86_64::convert_bf16_to_f32_avx2(src, dst, len);
        }
    }

    #[cfg(target_arch = "aarch64")]
    {
        return super::aarch64::convert_bf16_to_f32_neon(src, dst, len);
    }
...
pub unsafe fn convert_f32_to_bf16(src: *const f32, dst: *mut u16, len: usize) {
    ...
    {
        if is_x86_feature_detected!("avx2") {
            return super::x86_64::convert_f32_to_bf16_avx2(src, dst, len);
        }
    }

    #[cfg(target_arch = "aarch64")]
    {
        return super::aarch64::convert_f32_to_bf16_neon(src, dst, len);
    }
