...
/// AVX2 reverse scalar subtract for f32: out[i] = scalar - a[i]
#[target_feature(enable = "avx2")]
...
/// AVX2 reverse scalar subtract for f64: out[i] = scalar - a[i]
#[target_feature(enable = "avx2")]
