//! SIMD-accelerated activation function dispatch and scalar fallbacks.
//!
//! This module provides:
//! - Top-level dispatch functions that select the best SIMD implementation
//! - Scalar fallback implementations for all activations
...
// ============================================================================
// f16/bf16 wrappers (block-convert through f32)
// ============================================================================
