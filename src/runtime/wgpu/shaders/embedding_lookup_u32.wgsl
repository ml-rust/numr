// Auto-generated embedding_lookup operation for u32
...
@group(0) @binding(0) var<storage, read_write> embeddings: array<u32>;
...
fn embedding_lookup_u32(@builtin(global_invocation_id) gid: vec3<u32>) {
    let idx = gid.x;
