// Auto-generated cat operations for u32
...
@group(0) @binding(0) var<storage, read_write> cat_src: array<u32>;
@group(0) @binding(1) var<storage, read_write> cat_dst: array<u32>;
@group(0) @binding(2) var<uniform> cat_params: CatParams;

@compute @workgroup_size(256)
fn cat_copy_u32(@builtin(global_invocation_id) gid: vec3<u32>) {
    let idx = gid.x;
