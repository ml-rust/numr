// Auto-generated scatter_reduce_max for u32
...
@group(0) @binding(0) var<storage, read> scatter_src: array<u32>;
...
fn scatter_reduce_max_u32(@builtin(global_invocation_id) gid: vec3<u32>) {
    let idx = gid.x;
    ...
    atomicMax(&scatter_dst[dst_idx], src_val);
}
