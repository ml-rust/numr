// Auto-generated repeat operation for i32
...
@group(0) @binding(0) var<storage, read_write> repeat_src: array<i32>;
@group(0) @binding(1) var<storage, read_write> repeat_dst: array<i32>;
@group(0) @binding(2) var<uniform> repeat_params: RepeatParams;

@compute @workgroup_size(256)
fn repeat_i32(@builtin(global_invocation_id) gid: vec3<u32>) {
    let idx = gid.x;
