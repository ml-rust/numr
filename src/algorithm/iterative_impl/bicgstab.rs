...
use crate::algorithm::iterative::{BiCgStabOptions, BiCgStabResult, PreconditionerType};
...
use super::gmres::{apply_preconditioner, vector_dot, vector_norm};
        ...
        + ScalarOps<R>,
{
    ...
    for iter in 0..options.max_iter {
        ...
        let p_hat = apply_preconditioner(client, &precond, &p)?;
        ...
        let s_hat = apply_preconditioner(client, &precond, &s)?;
